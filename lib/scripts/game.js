                ...
                if (colours[x][y]) {
                    if (brightness(colours[x][y]) >= fish("#bright").value) {
                        if (fish("#debug").innerText == "on") {
                            game.innerHTML += "<div class='tile' tabindex='0' style='background-color: "+colours[x][y]+"; grid-row: "+(y+1)+"; grid-column: "+(x+1)+";'><span class='tile-label light'>"+y+","+x+"</span><h1 class='tile-label light'>"+layout[y][x]+"</h1></div>";
                        } else {
                            game.innerHTML += "<div class='tile' tabindex='0' style='background-color: "+colours[x][y]+"; grid-row: "+(y+1)+"; grid-column: "+(x+1)+";'><span class='tile-label light hidden'>"+y+","+x+"</span><h1 class='tile-label light'>"+layout[y][x]+"</h1></div>";
                        }
                    } else if (brightness(colours[x][y]) <= fish("#bright").value) {
                        if (fish("#debug").innerText == "on") {
                            game.innerHTML += "<div class='tile' tabindex='0' style='background-color: "+colours[x][y]+"; grid-row: "+(y+1)+"; grid-column: "+(x+1)+";'><span class='tile-label dark'>"+y+","+x+"</span><h1 class='tile-label dark'>"+layout[y][x]+"</h1></div>";
                        } else {
                            game.innerHTML += "<div class='tile' tabindex='0' style='background-color: "+colours[x][y]+"; grid-row: "+(y+1)+"; grid-column: "+(x+1)+";'><span class='tile-label dark hidden'>"+y+","+x+"</span><h1 class='tile-label dark'>"+layout[y][x]+"</h1></div>";
                        }
                    }
                } else {
                    if (fish("#debug").innerText == "on") {
