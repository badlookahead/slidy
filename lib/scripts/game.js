        ...
        for (let x = 0; x < layoutX; x++) {
            ...
            if (layout[x][y]) {
                if (colours[x][y]) {
                    ...
                    if (fish("#debug").innerText == "on") {
                        game.innerHTML += "<div class='tile blank-tile' style='grid-row: "+(x+1)+"; grid-column: "+(y+1)+";'><span class='tile-label light'>"+x+","+y+"</span><h1 class='tile-label light'>"+layout[x][y]+"</h1>"+"</div>";
                    } else {
                        game.innerHTML += "<div class='tile blank-tile' style='grid-row: "+(x+1)+"; grid-column: "+(y+1)+";'><h1 class='tile-label light hidden'>"+layout[x][y]+"</h1>"+"</div>";
                    }
                }   
            }
        }
